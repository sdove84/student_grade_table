...
function createStudent(){
    var student_data={api_key: '9D0KehsJ6k',name:$("#studentName").val(), course:$("#course").val(), grade:$("#studentGrade").val()};
    $.ajax({
        data: student_data,
        dataType: 'json',
...
function deleteStudent(student_id){
    var remove_student={api_key: '9D0KehsJ6k', student_id: student_id };
    $.ajax({
        data: remove_student,
        dataType: 'json',
